...
class MusicDataset(Dataset):
    ...
    def _get_audio_sample_label(self, index):
        label = self.annotations.iloc[index]["decode_rhythm"]
    ...
    def _targetTensor(self, label):
        ...
        rt_indexes = [int(all_note.index(rt)) for rt in label]
...
if __name__ == "__main__":
    ...
    audio_dir = "dataset/midilike_same5note_data"
    ANNOTATIONS_FILE = audio_dir + "/train_metadata.csv"
