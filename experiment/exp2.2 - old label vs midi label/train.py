...
def main():
    ...
    train_metadata = "dataset/long_length_data/train_metadata.csv"
    test_metadata = "dataset/long_length_data/test_metadata.csv"
    validation_dir = None
    model_name = "transformer_linear" # ['lstm', 'transformer_linear', 'transformer_conv2d']
    log_tags = [model_name, audio_dir, "midi-like", "custom-loss"]
    log_notes = None
    random_state = 2
