...
def fs(input, output):
  ...
  midi_file = f'C:\\Users\\Administrator\\OneDrive - KMITL\\Desktop\\study\\!project\\dataset\\01-simple rhythm\\{input}'
  output_file = f'C:\\Users\\Administrator\\OneDrive - KMITL\\Desktop\\study\\!project\\dataset\\01-simple rhythm\\{output}'
...
def create_track(file_number):
    ...
    rhythms = list(rhythm_dict.keys())
    rhythm_label = []

    while start_time < total_beats:
        label = random.choice(rhythms)
    ...
    with open(f"C:\\Users\\Administrator\\OneDrive - KMITL\\Desktop\\study\\!project\\dataset\\01-simple rhythm\\sound{file_number}.mid", "wb") as output_file:
...
df.to_csv('C:\\Users\\Administrator\\OneDrive - KMITL\\Desktop\\study\\!project\\dataset\\01-simple rhythm\\metadata.csv', index=False)
