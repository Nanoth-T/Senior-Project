...
class MusicDataset(Dataset):
    ...
    def plot_spectrogram(self, specgram, title, subtitle=0, ylabel="freq_bin", ax=None):
        ...
        specgram = specgram.cpu().detach().numpy()
        plt.imshow(specgram, aspect='auto', origin='lower', cmap='viridis')
...
if __name__ == "__main__":
    ...
    rhythm_dict = {"SOS": 0, "whole": 1, "half": 2, "quarter": 3, "8th": 4, "16th": 5, "EOS":7,}
