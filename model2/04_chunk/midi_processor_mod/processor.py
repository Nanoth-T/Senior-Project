...
# RANGE_NOTE = 128
# RANGE_TIME_SHIFT = 500 # The time shift is in units of centiseconds (1/100th of a second). #นะนด
# RANGE_VEL = 128

# START_IDX = {
#     'note': 0,
#     'time_shift': RANGE_NOTE,
#     'velocity': RANGE_NOTE + RANGE_TIME_SHIFT
# }
...
#         range_note = range(0, RANGE_NOTE)
#         range_time_shift = range(RANGE_NOTE,RANGE_NOTE+RANGE_TIME_SHIFT)
#         range_vel = range(RANGE_NOTE+RANGE_TIME_SHIFT, RANGE_NOTE+RANGE_TIME_SHIFT+RANGE_VEL)

#         valid_value = int_value

#         if int_value in range_note:
#             return {'type': 'note', 'value': valid_value}
#         elif int_value in range_time_shift:
#             valid_value -= (RANGE_NOTE)
#             return {'type': 'time_shift', 'value': valid_value}
#         elif int_value in range_vel:
#             valid_value -= (RANGE_NOTE + RANGE_TIME_SHIFT)
...
#         modified_velocity = snote.velocity
...
#     time_interval = int(round((post_time - prev_time) * 100)) # 100 = 10ms = 1cs
#     results = []
...
#         notes += inst_notes
#         break # need only first track # นะนด
#     # print(notes)
...
class Event:
    ...
    def _type_check(int_value):
        ...
        range_vel = range(RANGE_NOTE_ON+RANGE_NOTE_OFF+RANGE_TIME_SHIFT, RANGE_NOTE_ON+RANGE_NOTE_OFF+RANGE_TIME_SHIFT+RANGE_VEL)
...
if __name__ == '__main__':
    encoded = encode_midi('dataset/sample_audio1/Happy_Birthday_To_You_C_Major.mid')
    print(encoded)
    print("----")
    decoded = decode_midi(encoded)
    ...
    # ins = pretty_midi.PrettyMIDI('dataset/sample_audio1/Happy_Birthday_To_You_C_Major.mid')
    # # print(ins)
    # # print(ins.instruments[0])
    # for i in ins.instruments:
    #     # print(i.control_changes)
