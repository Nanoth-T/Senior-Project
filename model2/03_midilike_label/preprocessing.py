...
def custom_collate_fn(output_dict):
    def collate_fn(batch):
        ...
        signal_list, targetinput_list, labeltensor_list, info_list = [], [], [], []

        # Extract data from each sample in the batch
        for signal, target_input, label_ten, info in batch:
        ...
        return signal_batch, targetinput_batch, labeltensor_batch, info_list
    return collate_fn
