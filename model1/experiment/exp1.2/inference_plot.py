...
def plot_confusion_matrices(wrong, rhythm_dict):
    ...
    for index, data in wrong.items():  # Iterate over dictionary entries
        ...
        ConfusionMatrixDisplay.from_predictions(true_labels, pred_labels, cmap=plt.cm.Blues, ax=axes[row, col])
...
if __name__ == "__main__":
    ...
    path = "02_exp_bidirectional/exp_log/dataset/data6note_timelength200_1st"
    file = "all_data.csv"
    file_dir = f"{path}/{file}"
